    ...
    try:
        ...
        <head>
            ...
            <script>
                ...
                function sendWhatsApp(id, position) {{
                    ...
                    // O navegador faz a codificação UTF-8 aqui.
                    // Isso evita os emojis aparecerem como � no WhatsApp.
        ...
        <body>
            <div class="wrap">
                ...
                <p class="sub">
                    Mensagem, imagem, preço e link afiliado prontos. Envie, marque como enviada
                    e o painel pula para a próxima oferta.
                </p>
