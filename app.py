...
def painel_ofertas():
    try:
        ...
        for r in rows:
            ...
            whatsapp_url = "https://wa.me/?text=" + quote(mensagem, safe="")
            imagem = image_url or ""
            ...
            <div class="card">
                ...
                <div class="content">
                    ...
                    <div class="actions">
                        <button onclick="copyText('msg-{position}')">Copiar mensagem</button>
                        <a class="btn whatsapp" href="{whatsapp_url}" target="_blank">Enviar no WhatsApp</a>
                        <a class="btn" href="{affiliate_url}" target="_blank">Abrir link afiliado</a>
                        <a class="btn" href="{imagem}" target="_blank">Abrir imagem</a>
                    </div>
                </div>
            </div>
            """
        ...
        <body>
            <div class="wrap">
                ...
                <p>
                    Cada oferta já está com preço, imagem e seu link afiliado.
                    O botão do WhatsApp abre o compartilhamento com a mensagem preenchida;
                    aí você escolhe o grupo.
                </p>

                <div class="top-actions">
                    <a class="btn" href="/lote-afiliado?q=iphone">Gerar novo lote</a>
